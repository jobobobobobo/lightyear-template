use bevy::prelude::*;
use lightyear::prelude::{client::{ClientCommandsExt, Confirmed, Predicted}, ClientConnectionManager, Replicated};
...
fn cleanup_on_exit_to_menu(
    ...
    q_everything: Query<Entity, Or<(With<Geometry>, With<Predicted>, With<Confirmed>, With<Replicated>)>>,
    ...
    let _ = client_manager.send_message::<Reliable, ClientHostRequestShutdown>(&ClientHostRequestShutdown);
